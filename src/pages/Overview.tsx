...
const Overvie = () => {
            ...
            <div className="items-center bg-white flex justify-between gap-5 mt-6 p-6 max-md:px-5">
              ...
              <div className="items-stretch self-stretch flex grow basis-[0%] flex-col">
                <div className="justify-between items-stretch flex gap-5">
                  ...
                  <div className="text-black text-sm leading-5 whitespace-nowrap">
                    {lastestOrder?.deliveryStatus.taskStatusDate}
                  </div>
                </div>
                <div className="justify-between items-stretch flex gap-5 mt-2.5">
                  ...
                  <div className="text-black text-sm leading-5 whitespace-nowrap">
                    {lastestOrder?.deliveryStatus.deliveryStatusDate}
                  </div>
                </div>
                <div className="justify-between items-stretch flex gap-5 mt-2.5">
                  <div className="text-black text-sm leading-5 whitespace-nowrap">
                  ...
                  <div className="text-black text-sm leading-5 whitespace-nowrap">
                    {lastestOrder?.deliveryStatus.pickUpDate}
                  </div>
                </div>
                <div className="justify-between items-stretch flex gap-5 mt-2.5">
                  <div className="text-black text-sm leading-5 whitespace-nowrap">
                  ...
                  <div className="text-black text-sm leading-5 whitespace-nowrap">
                    {lastestOrder?.deliveryStatus.deliveryDate}
                  </div>
                </div>
              </div>
            </div>
  ...
  return (
    <>
      ...
      <div className="absolute top-[88px] left-[978px] flex flex-col items-center justify-start py-4 px-8 gap-[32px] text-sm text-black">
        ...
        {/* <div> */}
        <div className="relative items-stretch border border-[color:var(--Grey-200,#EAECF0)] flex flex-col p-4 rounded-xl border-solid bg-gray20 ml-12 max-w-[100%] top-[96px] left-[-15px]">
