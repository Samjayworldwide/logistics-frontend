...
const CreateNewOrder = () => {
  return (
    ...
    <MyHeader current_tab={"Overview"} />
      <div className="top-[0%] left-[2%] mt-1 rounded-xl w-full overflow-hidden text-center text-5xl text-white items-stretch  justify-between gap-4 ml- mt-4 max-md:max-w-full max-md:flex-wrap">
        ...
        <div className="absolute top-[33%] right-[1%] flex flex-col w-[30%] h-[60%] justify-start py-4 px-8  text-sm text-black max-md:max-w-full">
