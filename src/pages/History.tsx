...
const History: FunctionComponent = () => {
  ...
  useEffect(() => {
    ...
    globalThis.senderAddress = details?.pickUpLocation as string
  ...
  return (
      ...
      <MyHeader current_tab={"History"} />
        <div className="bg-white  w-full h-[60rem] overflow-hidden text-left text-base text-main-text font-body-text-normal-16">
        <div className="absolute bottom-[-5px] left-[1008px] bg-log-pri2 flex flex-col items-start justify-start py-[50px] px-6 gap-[24px] text-darkblue">
          ...
          <div className="flex flex-col items-center justify-start pt-0 px-0 pb-6 gap-[24px] text-xs text-black">
            <div className="relative w-[350px] h-[460px] text-red">
            ...
            <div className="self-stretch rounded-81xl bg-log-pri cursor-pointer hover:bg-purple-500 overflow-hidden flex flex-row items-center justify-center py-3 px-4 gap-[8px] text-sm text-white border-[1px] border-solid border-log-pri2 rounded-3xl">
