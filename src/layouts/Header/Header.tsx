...
const MyHeader = ({current_tab}:Props) => {
  ...
  const home = () => {
    ...
    return (
        <nav className="m-0 relative  max-w-full h-[200px] bg-white overflow-hidden text-left text-base text-main-text font-body-text-normal-16">
        <header
        ...
        >
          ...
          <div className="flex flex-row items-center justify-start mt-[-1.5rem] mr-[-5%] gap-[16px]">
            ...
            <img
              ...
              alt=""
              src={localStorage.getItem("profilePic") ||  "https://cdn.builder.io/api/v1/image/assets/TEMP/02487d23-1063-4dbe-b3bf-f05c18e2bcbf?"}
              onClick={openModal}
            />
          </div>
        </header>
